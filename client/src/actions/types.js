...
export const ACTIVE_STAFF_FILTER = "ACTIVE_STAFF_FILTER";
export const JOB_QUEUE_PROJECTS = "JOB_QUEUE_PROJECTS";
export const DAILY_JOBSHEET_PROJECTS = "DAILY_JOBSHEET_PROJECTS";
export const DAILY_JOBSHEET_EXCEL_EXPORT = "DAILY_JOBSHEET_EXCEL_EXPORT";
...
export const ACTIVE_REPORT_CLIENTS = "ACTIVE_REPORT_CLIENTS";
export const CLIENTS_REPORT_DATA = "CLIENTS_REPORT_DATA";
export const CLIENT_JOB_SUMMARY = "CLIENT_JOB_SUMMARY";
...
export const DCT_CALLS_CLIENT_COUNT = "DCT_CALLS_CLIENT_COUNT";
export const DCT_CALLS_COUNT = "DCT_CALLS_COUNT";
export const ALL_BILLING_CLIENT = "ALL_BILLING_CLIENT";
export const GET_ALL_LEADS_ENTERED_BY = "GET_ALL_LEADS_ENTERED_BY";
export const GET_LEADS_ENTERED_BY = "GET_LEADS_ENTERED_BY";
//SCT
...
export const ALL_DEMOS_TAKEN = "ALL_DEMOS_TAKEN";
export const ALL_DEMOS_TODAY_ADDED = "ALL_DEMOS_TODAY_ADDED";
export const ALL_DCT_LEAD_ENTRY_TODAY = "ALL_DCT_LEAD_ENTRY_TODAY";
...
export const GET_SCT_LEADS_LIST = "GET_SCT_LEADS_LIST";
export const GET_SELECTED_CLIENT = "GET_SELECTED_CLIENT";
export const SELECTED_PROJECT = "SELECTED_PROJECT";
export const SCT_CALLS_CLIENT_COUNT = "SCT_CALLS_CLIENT_COUNT";
export const ALL_SCT_ASSIGNED_LEAD_DETAILS = "ALL_SCT_ASSIGNED_LEAD_DETAILS";
export const SCT_CALLS_COUNT = "SCT_CALLS_COUNT";
export const ALL_LEAD_ENTRY_TODAY = "ALL_LEAD_ENTRY_TODAY";

//SETTINGS
export const ALL_COMPANY_DETAILS = "ALL_COMPANY_DETAILS";
export const ALL_TEAMS_DETAILS = "ALL_TEAMS_DETAILS";
...
export const UNRESOLVED_ENQUIRY_DETAILS = "UNRESOLVED_ENQUIRY_DETAILS";
export const EXST_SCREENSHOT = "EXST_SCREENSHOT";

export const EXST_PROJ_SCREENSHOT = "EXST_PROJ_SCREENSHOT";
export const GET_FILE = "GET_FILE";

export const ALL_EXCEL_FILES = "ALL_EXCEL_FILES";
